...
The Physics Simulation Machine closes the interaction loop for the testbed nodes, allowing the physical dynamics of the RCPS nodes to be simulated in the environment in which it would be deployed, \emph{e.g.} satellites' orbital mechanics and interactions can be simulated for a satellite cluster. 
...
% Explain the concept of checkpoint here. Note that this requires cooperation from the implementor of the LRO - checkpoints have to be built into the code. 
...
% Does this figure contribute? Have you explained the graphical notation before? I have not found it... Maybe a better textual explanation would be better.
...
\begin{figure}[h]
	\centering
	\includegraphics[width=\textwidth]{ksp_combined}
